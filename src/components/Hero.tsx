...
/** Bold / energetic speed-first hero with the app phone mockup. */
      ...
      <div className="container" style={{ position: "relative", zIndex: 2 }}>
        ...
        >
          ...
          <div>
            <h1
              className="display"
              style={{ fontSize: "clamp(56px, 9vw, 128px)", lineHeight: 0.92, margin: "0 0 24px", letterSpacing: "-0.05em" }}
            >
              {t.hero.title1}
              <br />
              <span
          ...
          <div style={{ position: "relative", display: "grid", placeItems: "center", minHeight: 600 }}>
            ...
            <div
              style={{
                ...
                alignItems: "center",
                gap: 10,
                animation: "zbr-float 4s ease-in-out infinite",
              }}
            >
              <div
                style={{
            ...
            <div
              style={{
                ...
                borderRadius: 16,
                boxShadow: "var(--shadow-md)",
                animation: "zbr-float 5s ease-in-out infinite 1s",
              }}
            >
